...
Once we have the offline version available, we can then have the new version available that can work online and talk to LLMs for generating the questions and giving answers and feedback.
